...
//    self.backgroundColor = [UIColor colorWithWhite:0.0 alpha:0.8];
    ...
    _background.backgroundColor = [UIColor colorWithWhite:0.5 alpha:0.8];
    ...
    _textColor = LCHexColor(0xFF4342);
...
- (void)layoutSubviews {
    ...
    [self.items enumerateObjectsUsingBlock:^(DOPNavbarMenuItem *obj, NSUInteger idx, BOOL *stop) {
        ...
        icon.center = CGPointMake(buttonWidth/2-2, buttonHeight/2-15);
